...
## 1. Basic facts
- Japanese photographer, writer on photography, and editor born in 1936.[S1][S2]
- Also important as a historian, organizer, and editor of books on museum and photography collections, in addition to his own photographic work.[S1][S2][S3]

## 2. Expression / method
- Main themes: performance and stage portraiture, postwar Japanese cultural life, photographic historiography, and the relation between image-making and photography’s institutional memory.[S1][S2][S3]
- Representative work examples: collection records such as *Fubuki Koshiji from Long Recital at Nissei Theater* and the *Venice* series are central because they show the two poles of his practice currently most visible in institutional holdings: performance/cultural portraiture and later travel or place-based images.[S2][S3][S4]
- Technique / formal traits: the currently visible institutional records suggest a refined black-and-white and later color photographic practice attentive to public appearance, theatricality, and scene construction, though the reviewed sources are still stronger on collection and historical framing than on close formal criticism.[S1][S2][S3]
- Why this method was chosen: the strongest support currently available comes indirectly from Matsumoto’s wider activity as a writer and editor on photography collections. His practice appears closely tied to questions of how photographic culture is preserved, exhibited, and remembered, not just how images are captured.[S1][S2]
- Historical context: Matsumoto belongs to the generation that shaped postwar Japanese photography both through image-making and through the building of historical awareness around photography as a field. This dual role is historically important for situating him.[S1][S2][S3]
- Relation to contemporaries or movements: he belongs within postwar Japanese photography, but differs from more easily canonized “style” movements because his significance also lies in historiography and institutional reflection.[S1][S2]
- Historical significance: Matsumoto matters because he is both practitioner and mediator of photographic history. His role in shaping how photography collections and museum contexts are understood is itself historically significant.[S1][S2]
- Critical meaning: the available material supports a careful conclusion that Matsumoto’s contribution cannot be reduced to a single visual style; instead, his practice sits at the intersection of making photographs, writing their histories, and structuring their institutional afterlife.[S1][S2][S3]
- Where and how the work was used: Top Museum collection records, the APJ dictionary entry, and exhibition references are especially useful because they confirm both his presence in major institutional collections and his importance as a writer/editor within Japanese photography.[S1][S2][S3][S4]

## 3. Criticism and reception
- Current source material is stronger on institutional presence and historiographic role than on thick critical essays about individual pictures.[S1][S2][S3]
- Final website copy should therefore emphasize Matsumoto’s dual identity as photographer and writer/editor, rather than forcing a fully developed formal reading not yet supported by strong sources.[S1][S2]
- This note should be treated as a solid foundation, but one that would benefit from additional Japanese-language criticism or catalogue essays later.[S1][S2][S3]
...
表現解説では、everyday-life, place memory, quiet documentary を中心語にしつつ、作品を単なる代表作紹介で終わらせないことが重要である。とくに、なぜこの方法が1980–1990年代の美術館制度、写真集文化、ポストモダン以後のイメージ批評、グローバル化する都市・身体・社会の文脈で意味を持ったのかを説明したい。比較対象としては Takashi Homma, Takashi Yasumura を優先し、浅い類似ではなく、写真観、方法、対象の捉え方、受容史の差異を整理する。

評価・批評では、同時代の展覧会、写真集、ギャラリーでの流通、後年の美術館・研究機関による再評価を分けて扱う。松本徳彦は1980–1990年代以降の写真表現を、制度、メディア、場所、主体の問題として読み直すための重要な作家。 この一文を起点に、本文では「何を撮ったか」よりも「その方法が何を変えたか」を中心に組み立てる。

### 8.2 座標用補助メモ（本文には直接反映しない内部用）
```yaml
id: norihiko-matsumoto
name_ja: "松本徳彦"
name_en: "Norihiko Matsumoto"
birth_year: ""
death_year: ""
active_eras: ["1980s", "1990s"]
countries: ["Japan"]
movements: ["Japanese contemporary photography"]
platforms: ["museum exhibitions", "photobooks / monographs", "gallery and archive circulation", "critical journals"]
subjects: ["urban space", "everyday environment", "place"]
methods: ["color observation", "series work", "book-oriented practice"]
concepts: ["everyday-life", "place memory", "quiet documentary"]
influenced_by: ["Takashi Homma", "Takashi Yasumura"]
related_figures: ["Takashi Homma", "Takashi Yasumura"]
description_short: "松本徳彦は1980–1990年代以降の写真表現を、制度、メディア、場所、主体の問題として読み直すための重要な作家。"
confidence: 0.72
...
axes:
  ...
  materiality: 3
surface_connections: ["Japanese contemporary photography", "Japan / 1980–1990s"]
deep_connections: ["松本徳彦は1980–1990年代以降の写真表現を、制度、メディア、場所、主体の問題として読み直すための重要な作家。", "color observation, series work, book-oriented practiceという方法を通じて、everyday-life, place memory, quiet documentaryを写真史的な問題として扱う。"]
comparison_targets: ["Takashi Homma", "Takashi Yasumura"]
one_sentence_connection: "松本徳彦は1980–1990年代以降の写真表現を、制度、メディア、場所、主体の問題として読み直すための重要な作家。"
tags: ["everyday-life", "place memory", "quiet documentary"]
```
...
- Norihiko Matsumotoの本人インタビュー、作家ステートメント、写真集序文を優先して確認する。
