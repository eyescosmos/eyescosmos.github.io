...
## 1. Basic facts
- Chinese artist born in 1971, working across film, video, photography, installation, and painting.[S1][S2][S3]
- Better known internationally for film and moving image, but staged photography is an important part of his practice and of his relation to contemporary Chinese image culture.[S1][S2][S3]

## 2. Expression / method
- Main themes: modernity, alienation, urban life, intellectual identity, historical transition, dreamlike temporality, and the fragile relation between private desire and collective transformation.[S1][S2][S3]
- Representative work examples: early photographic series and the visual worlds around projects such as *Estranged Paradise* and *The General’s Smile* are central because they show how Yang constructs stylized, often black-and-white environments where modern Chinese life appears both cinematic and estranged.[S1][S2][S3]
- Technique / formal traits: staged mise-en-scène, strong reference to cinema and painting, carefully choreographed figures, and a tendency toward atmospheric black-and-white imagery. Even in still photographs, the image feels suspended inside a longer temporal sequence.[S1][S2][S3]
- Why this method was chosen: Yang’s practice often uses staged images to examine how subjectivity is shaped inside rapidly changing social systems. Photography and film let him construct worlds where atmosphere and rhythm become historical arguments rather than mere style.[S1][S2]
- Historical context: his work emerges in the late 1990s and 2000s, when Chinese contemporary art was gaining international visibility and when artists were grappling with modernization, market transformation, and new visual regimes. Yang’s use of staged imagery belongs to that context while resisting straightforward social realism.[S1][S2][S3]
- Relation to contemporaries or movements: Yang can be placed alongside contemporary Chinese video and photography, but his practice is distinctive in the way it merges painterly composition, cinematic duration, and photographic staging. He is less a documentary observer than a constructor of historical mood.[S1][S2][S3]
- Historical significance: he matters because he helped define a generation of Chinese artists for whom photography and film became means of rethinking modernity not as documentation alone but as atmosphere, fiction, and philosophical distance.[S1][S2][S3]
- Critical meaning: the work matters because it gives historical transition a dreamlike form. Yang’s images do not explain modern China directly; they show how change is lived as estrangement, suspension, and uncertain self-positioning.[S1][S2][S3]
- Where and how the work was used: his work circulated through museum surveys, biennials, and exhibitions in Europe, Asia, and the United States. Museo Esteban Vicente and other institutional biographies are useful because they connect his still and moving-image work to international reception after Documenta 11.[S1][S3]

## 3. Criticism and reception
- Museo Esteban Vicente’s exhibition text is especially useful because it explicitly connects Yang’s international breakthrough to Documenta 11 and frames his image world in relation to intellectual identity and changing Chinese society.[S1]
- Reception often emphasizes the cinematic and painterly qualities of his work, but final website copy should stress that photography remains central to how those qualities are staged and circulated.[S1][S2][S3]
- His historical importance in photography-related terms lies in showing how staged still image and moving image could work together as part of a larger post-socialist visual language.[S1][S2]
...
表現解説では、modernity, melancholy, cinematic time を中心語にしつつ、作品を単なる代表作紹介で終わらせないことが重要である。とくに、なぜこの方法が1980–1990年代の美術館制度、写真集文化、ポストモダン以後のイメージ批評、グローバル化する都市・身体・社会の文脈で意味を持ったのかを説明したい。比較対象としては Wang Qingsong, Hiroshi Sugimoto, Jeff Wall を優先し、浅い類似ではなく、写真観、方法、対象の捉え方、受容史の差異を整理する。

評価・批評では、同時代の展覧会、写真集、ギャラリーでの流通、後年の美術館・研究機関による再評価を分けて扱う。楊福東は1980–1990年代以降の写真表現を、制度、メディア、場所、主体の問題として読み直すための重要な作家。 この一文を起点に、本文では「何を撮ったか」よりも「その方法が何を変えたか」を中心に組み立てる。
...
countries: ["China"]
movements: ["cinematic photography", "Chinese contemporary art"]
platforms: ["museum exhibitions", "photobooks / monographs", "gallery and archive circulation", "critical journals"]
subjects: ["youth", "modernity", "literati imagery", "cinema"]
methods: ["black-and-white film stills", "staged scenes", "multi-channel film"]
concepts: ["modernity", "melancholy", "cinematic time"]
influenced_by: ["Wang Qingsong", "Hiroshi Sugimoto", "Jeff Wall"]
related_figures: ["Wang Qingsong", "Hiroshi Sugimoto", "Jeff Wall"]
description_short: "楊福東は1980–1990年代以降の写真表現を、制度、メディア、場所、主体の問題として読み直すための重要な作家。"
confidence: 0.72
...
axes:
  ...
  materiality: 5
surface_connections: ["cinematic photography, Chinese contemporary art", "China / 1980–1990s"]
deep_connections: ["楊福東は1980–1990年代以降の写真表現を、制度、メディア、場所、主体の問題として読み直すための重要な作家。", "black-and-white film stills, staged scenes, multi-channel filmという方法を通じて、modernity, melancholy, cinematic timeを写真史的な問題として扱う。"]
comparison_targets: ["Wang Qingsong", "Hiroshi Sugimoto", "Jeff Wall"]
one_sentence_connection: "楊福東は1980–1990年代以降の写真表現を、制度、メディア、場所、主体の問題として読み直すための重要な作家。"
tags: ["modernity", "melancholy", "cinematic time"]
```
...
- Yang Fudongの本人インタビュー、作家ステートメント、写真集序文を優先して確認する。
