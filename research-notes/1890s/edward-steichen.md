...
>
> Site id / slug reference: `edward-steichen`. Formal counted/direct source candidates in this note: 24.

## 1. Basic facts / verified points
- Met essay は “Photo-Secession Years” を、Stieglitz とともに写真の芸術的地位を押し上げた時期として整理する。[S1]
- 《The Flatiron》は気象、夜景、構図を総合した都会の象徴像として読まれてきた。[S2]
- Steichen はフランスとの往還を通じて、Rodin, Matisse, modern European art を 291 に媒介する役割も担った。[S1][S3]

## 2. Expression / method / historical context
この時代のスタイケンは、後年の MoMA 写真部門長ではなく、スティーグリッツと組みながらピクトリアリズムと Photo-Secession を国際化した若き媒介者として書くべきである。フランスでの経験、ヨーロッパ美術の紹介、印画と絵画の境界横断が鍵になる。[S1][S2][S3]

スタイケンは、この時代には後年のMoMA部門長ではなく、ピクトリアリズムとPhoto-Secessionを国際化した若い媒介者として書くべきである。パリでロダンや近代美術に接し、スティーグリッツと291を形成し、《The Flatiron》のように都市、霧、色彩、絵画的構成を写真へ変換した。彼は写真家であると同時に、ヨーロッパ前衛とアメリカ写真制度を接続する翻訳者だった。
...
スタイケンは、ピクトリアリズムの技巧を極めながら、ヨーロッパ近代美術をアメリカへ媒介した点でPhoto-Secession内でも特異である。彼の初期作品は、絵画的写真の完成と、その先の近代写真制度への橋を同時に示す。
...
- [S7] Pictorialist acquisition including Steichen. Getty. https://www.getty.edu/news/getty-museum-acquires-pictorialist-photographs
- [S8] Self-Portrait. Metropolitan Museum of Art. https://www.metmuseum.org/art/collection/search/267843
- [S9] Edward Steichen object page. ICP. https://www.icp.org/browse/archive/objects/edward-steichen
...
- Photo-Secession and 291 exhibitions
