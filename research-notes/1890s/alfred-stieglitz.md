...
>
> Site id / slug reference: `alfred-stieglitz`. Formal counted/direct source candidates in this note: 28.

## 1. Basic facts / verified points
- 1890 年にドイツから帰国した Stieglitz は、写真を絵画・彫刻と同等の芸術として認めさせることを目標にした。[S1]
- Camera Notes、Photo-Secession、Camera Work、291 は、その制度化のための連続した装置だった。[S1][S2]
- 《The Terminal》は小型カメラによる都市即応性を、《The Steerage》は日常的都市／移民空間と近代構成を結びつける転換点を示す。[S4][S5][S6]
- Met は《Equivalent》を情動のアナロジーとして読み、NGA/AIC は “Key Set” と cloud pictures の長い受容史を支えている。[S1][S7][S8]
- 彼の実践は Paul Strand, O’Keeffe, European modernism の受容と不可分である。[S1][S2]

## 2. Expression / method / historical context
1890–1910s のスティーグリッツは、個人作家である以上に、編集者、組織者、制度設計者として読む必要がある。彼の重要性は《The Steerage》一枚だけでなく、Camera Work、Photo-Secession、291 を通じて写真を近代芸術の制度へ押し上げた総合的実践にある。[S1][S2][S3]

スティーグリッツは、1890–1910sでは作家、編集者、キュレーター、ギャラリスト、制度設計者が一体になった人物として扱う必要がある。Photo-Secession、Camera Work、291は、写真作品そのものだけでなく、写真を近代芸術として流通させる仕組みだった。《The Terminal》や《The Steerage》では都市の即応性と近代構成が現れ、のちの《Equivalent》へ向かう抽象化の前提も見える。
...
スティーグリッツの受容は、作品評価だけではなく制度史で見る必要がある。Camera Work、291、Key Setは、写真作品の価値づけ、保存、展示、近代美術との接続をまとめて変えた装置だった。
...
- [S7] Equivalent. Metropolitan Museum of Art. https://www.metmuseum.org/art/collection/search/267822
- [S8] Introduction to the Key Set. National Gallery of Art. https://www.nga.gov/research/publications/alfred-stieglitz-key-set/introduction-key-set
- [S9] The Key Set: 1902–1917. National Gallery of Art. https://www.nga.gov/research/publications/alfred-stieglitz-key-set/key-set-1902-1917
- [S10] The Alfred Stieglitz Collection. Art Institute of Chicago. https://archive.artic.edu/stieglitz/about/
- [S11] Equivalent. Art Institute of Chicago. https://www.artic.edu/artworks/66622/equivalent
- [S12] Alfred Stieglitz / Georgia O’Keeffe Archive. Yale Archives. https://archives.yale.edu/repositories/11/resources/1846
- [S13] 291: Photographers in the circle of Alfred Stieglitz. NGV. https://www.ngv.vic.gov.au/exhibition/291/
...
- Camera Work issues
- 291 exhibition catalogues
- correspondence with O’Keeffe / Strand
