...
この作家の表現は、telephoto observation、field documentary、color wildlife photography を通じて、animal life、ecology、popular photographic media を可視化する点にある。[S1] 1970–1980年代は、古典的なドキュメンタリー、決定的瞬間、モダニズム的な形式美だけでは写真を説明しきれなくなった時期である。カラー写真、コンセプチュアル・アート、写真集、フェミニズム、ポスト・プロヴォーク、ニュー・トポグラフィックス、ポストドキュメンタリーが並行し、写真は出来事を「記録する」だけでなく、制度、身体、メディア、記憶、風景の読み方を問い直す媒体になった。[S3]

岩合光昭の場合、代表的な論点は Serengeti, animal books, NHK / media work に集約される。ここでは作品名を単に並べるのではなく、被写体との距離、画面の組み立て、発表媒体、写真集・展覧会・批評の文脈を一体で扱うとよい。野生動物と人間の生活圏を長期取材し、自然写真を出版・テレビ・大衆メディアへ広げた作家。 この点を、同時代の National Geographic photographers、Yoshino Oishi、Kazuyoshi Nomachi との比較で書くと、浅い分類ではなく写真史上の位置が見えやすくなる。[S4]

### 2補. 本文化で強める論点
本文では「何を撮ったか」よりも、「なぜその方法がその時代に必要だったか」を優先する。岩合光昭は、animals、ecosystems、cats、Africa、nature を扱うことで、写真が社会・制度・記憶・身体・風景のどこに介入できるのかを示した。後で本文化する際は、代表作、発表媒体、同時代の批評、後年の美術館での再評価をつなぎ、写真史の中で何を更新したのかを明確にする。

## 3. 評価・批評・歴史的意義 / Reception and significance
受容史では、wildlife photography、nature documentary、animal photography の枠で語られることが多いが、単一の運動名に閉じると射程が狭くなる。重要なのは、岩合光昭の写真が、同時代の視覚文化や展示制度の中でどのように読まれ、後年の写真史でどの論点を開いたかである。[S5] 美術館・ギャラリー・出版社・研究資料を併用し、作品の形式、社会的背景、批評的意味を分けて整理したい。[S6]

## 4. 座標用補助メモ（本文には直接反映しない内部用）
```yaml
id: mitsuaki-iwago
name_ja: "岩合光昭"
name_en: "Mitsuaki Iwago"
birth_year: 1950
death_year: 
active_eras: ["1970s", "1980s"]
countries: ['Japan']
movements: ['wildlife photography', 'nature documentary', 'animal photography']
platforms: ['Serengeti', 'animal books', 'NHK / media work']
subjects: ['animals', 'ecosystems', 'cats', 'Africa', 'nature']
methods: ['telephoto observation', 'field documentary', 'color wildlife photography']
concepts: ['animal life', 'ecology', 'popular photographic media']
influenced_by: ['National Geographic photographers', 'Yoshino Oishi', 'Kazuyoshi Nomachi']
related_figures: ['National Geographic photographers', 'Yoshino Oishi', 'Kazuyoshi Nomachi']
description_short: "野生動物と人間の生活圏を長期取材し、自然写真を出版・テレビ・大衆メディアへ広げた作家。"
confidence: 0.76
...
axes:
  ...
  materiality: 2
surface_connections: ["wildlife photography、nature documentary、animal photography", "Japan / 1970–1980s"]
deep_connections: ["野生動物と人間の生活圏を長期取材し、自然写真を出版・テレビ・大衆メディアへ広げた作家。", "telephoto observation、field documentary、color wildlife photography という方法を通じて、animal life、ecology、popular photographic media を写真史的な問題として扱う。"]
comparison_targets: ['National Geographic photographers', 'Yoshino Oishi', 'Kazuyoshi Nomachi']
one_sentence_connection: "野生動物と人間の生活圏を長期取材し、自然写真を出版・テレビ・大衆メディアへ広げた作家。"
tags: ['animal life', 'ecology', 'popular photographic media']
```
...
- [S8] Mitsuaki Iwago scholarship route. Google Scholar. https://scholar.google.com/scholar?q=Mitsuaki+Iwago+photography
- [S9] Mitsuaki Iwago route. National Geographic route. https://www.google.com/search?q=National+Geographic+route+Mitsuaki+Iwago+photography
- [S10] Mitsuaki Iwago route. Tokyo Art Beat. https://www.google.com/search?q=Tokyo+Art+Beat+Mitsuaki+Iwago+photography
