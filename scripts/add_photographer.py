...
def print_manual_checklist(spec: dict):
    ...
    print(f"□ EN 素材から en/photographers/{sid}.html を新規生成")
    print("    JA ページ完成後、render_en_page を通す（既存 EN への上書きは常に拒否）：")
    print(f"    python3 scripts/import_chatgpt_photographer.py --slug {sid} --render-en EN.html --apply")
