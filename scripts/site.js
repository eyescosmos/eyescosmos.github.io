...
const COUNTRY_TEXT = {
  ...
  MX: { ja: 'MX', en: 'Mexico' },
  SK: { ja: 'SK', en: 'Slovakia' },
  PL: { ja: 'PL', en: 'Poland' },
  LT: { ja: 'LT', en: 'Lithuania' },
  ...
  BE: { ja: 'BE', en: 'Belgium' },
  FI: { ja: 'FI', en: 'Finland' },
  CZ: { ja: 'CZ', en: 'Czech Republic' },
  AT: { ja: 'AT', en: 'Austria' },
  RO: { ja: 'RO', en: 'Romania' },
  ZA: { ja: 'ZA', en: 'South Africa' },
  NG: { ja: 'NG', en: 'Nigeria' },
  CN: { ja: 'CN', en: 'China' },
  IR: { ja: 'IR', en: 'Iran' },
  NO: { ja: 'NO', en: 'Norway' },
  AU: { ja: 'AU', en: 'Australia' },
  KR: { ja: 'KR', en: 'South Korea' },
  MA: { ja: 'MA', en: 'Morocco' },
  UA: { ja: 'UA', en: 'Ukraine' },
  IE: { ja: 'IE', en: 'Ireland' },
...
const PHOTOGRAPHER_COUNTRY_OVERRIDES = {
  'adam-broomberg-oliver-chanarin': { countryCode: 'ZA / GB' },
  'aglaia-konrad': { countryCode: 'AT' },
  'amalia-ulman': { countryCode: 'AR / ES' },
  'an-my-le': { countryCode: 'VN / US' },
  'anders-petersen': { countryCode: 'SE' },
  'aneta-grzeszykowska': { countryCode: 'PL' },
  'ann-sofi-siden': { countryCode: 'SE' },
  'annika-von-hausswolff': { countryCode: 'SE' },
  'ansel-adams': { countryCode: 'US' },
  'anthony-goicolea': { countryCode: 'US' },
  'anuschka-blommers-niels-schumm': { countryCode: 'NL' },
  'arno-nollen': { countryCode: 'NL' },
  'arthur-rothstein': { countryCode: 'US' },
  'artie-vierkant': { countryCode: 'US' },
  'axel-hutte': { countryCode: 'DE' },
  'barbara-probst': { countryCode: 'DE' },
  'beate-gutschow': { countryCode: 'DE' },
  'ben-shahn': { countryCode: 'LT / US' },
  'bill-brandt': { countryCode: 'GB' },
  brassai: { countryCode: 'HU / FR' },
  'bruno-serralongue': { countryCode: 'FR' },
  'charles-freger': { countryCode: 'FR' },
  'charlotte-dumas': { countryCode: 'NL' },
  'clunie-reid': { countryCode: 'GB' },
  'david-seymour': { countryCode: 'PL / US' },
  'diana-scheunemann': { countryCode: 'CH / DE' },
  'dirk-braeckman': { countryCode: 'BE' },
  'dorothy-bohm': { countryCode: 'LT / GB' },
  'ed-van-der-elsken': { countryCode: 'NL' },
  'edward-weston': { countryCode: 'US' },
  'eileen-quinlan': { countryCode: 'US' },
  'elina-brotherus': { countryCode: 'FI' },
  'ernest-cole': { countryCode: 'ZA' },
  'erik-steinbrecher': { countryCode: 'CH' },
  'erwin-wurm': { countryCode: 'AT' },
  'florian-maier-aichen': { countryCode: 'DE' },
  'francois-kollar': { countryCode: 'SK / FR' },
  'frank-van-der-salm': { countryCode: 'NL' },
  'gabor-osz': { countryCode: 'HU' },
  'gerard-byrne': { countryCode: 'IE' },
  'gonzalo-puch': { countryCode: 'ES' },
  'guadalupe-ruiz': { countryCode: 'MX / CH' },
  'heidi-specker': { countryCode: 'DE' },
  'helen-levitt': { countryCode: 'US' },
  'hellen-van-meene': { countryCode: 'NL' },
  'iosif-kiraly': { countryCode: 'RO' },
  izis: { countryCode: 'LT / FR' },
  'j-h-engstrom': { countryCode: 'SE' },
  'jack-delano': { countryCode: 'UA / US' },
  'james-casebere': { countryCode: 'US' },
  'james-welling': { countryCode: 'US' },
  'janaina-tschape': { countryCode: 'DE / BR' },
  'jean-luc-moulene': { countryCode: 'FR' },
  'jean-luc-mylayne': { countryCode: 'FR' },
  'jean-pierre-khazem': { countryCode: 'FR' },
  'jens-ullrich': { countryCode: 'DE' },
  'jessica-eaton': { countryCode: 'CA' },
  'jitka-hanzlova': { countryCode: 'CZ' },
  'joachim-koester': { countryCode: 'DK' },
  'jochen-lempert': { countryCode: 'DE' },
  'joel-meyerowitz': { countryCode: 'US' },
  'joel-sternfeld': { countryCode: 'US' },
  'john-riddy': { countryCode: 'GB' },
  'john-vachon': { countryCode: 'US' },
  'jose-antonio-hernandez-diez': { countryCode: 'VE' },
  'jules-spinatsch': { countryCode: 'CH' },
  'justine-kurland': { countryCode: 'US' },
  'juul-hondius': { countryCode: 'NL' },
  'kaoru-izima': { countryCode: 'JP' },
  'kate-steciw': { countryCode: 'US' },
  'kelli-connell': { countryCode: 'US' },
  'larry-clark': { countryCode: 'US' },
  'laura-letinsky': { countryCode: 'CA / US' },
  'lewis-baltz': { countryCode: 'US' },
  'lidwien-van-de-ven': { countryCode: 'NL' },
  'louis-faurer': { countryCode: 'US' },
  'louis-vaire': { countryCode: 'FR' },
  'luc-delahaye': { countryCode: 'FR' },
  'lucas-blalock': { countryCode: 'US' },
  'luisa-lambri': { countryCode: 'IT' },
  'lukas-einsele': { countryCode: 'DE' },
  'manfred-willmann': { countryCode: 'AT' },
  'manuel-alvarez-bravo': { countryCode: 'MX' },
  'marcel-bovis': { countryCode: 'FR' },
  'marco-poloni': { countryCode: 'CH' },
  'margaret-bourke-white': { countryCode: 'US' },
  'marine-hugonnier': { countryCode: 'FR' },
  'marnix-goossens': { countryCode: 'NL' },
  'martin-polak-lukas-jasansky': { countryCode: 'CZ' },
  'michael-janiszewski': { countryCode: 'DE' },
  'michael-wesely': { countryCode: 'DE' },
  'minor-white': { countryCode: 'US' },
  'natalie-czech': { countryCode: 'DE' },
  'nate-lowman': { countryCode: 'US' },
  'nikki-s-lee': { countryCode: 'KR / US' },
  'oliver-musovik': { countryCode: 'MK' },
  'olivo-barbieri': { countryCode: 'IT' },
  'paul-albert-leitner': { countryCode: 'AT' },
  'paul-graham': { countryCode: 'GB' },
  'pertti-kekarainen': { countryCode: 'FI' },
  'peter-piller': { countryCode: 'DE' },
  'pieter-hugo': { countryCode: 'ZA' },
  'philippe-terrier-hermann': { countryCode: 'FR' },
  'philip-lorca-dicorcia': { countryCode: 'US' },
  'rashid-johnson': { countryCode: 'US' },
  'ricarda-roggan': { countryCode: 'DE' },
  'richard-billingham': { countryCode: 'GB' },
  'robert-adams': { countryCode: 'US' },
  'robert-doisneau': { countryCode: 'FR' },
  'roe-ethridge': { countryCode: 'US' },
  'rosangela-renno': { countryCode: 'BR' },
  'roy-arden': { countryCode: 'CA' },
  'russell-lee': { countryCode: 'US' },
  'rut-blees-luxemburg': { countryCode: 'DE / GB' },
  'ruud-van-empel': { countryCode: 'NL' },
  'ryan-mcginley': { countryCode: 'US' },
  'sabine-bitter-helmut-weber': { countryCode: 'AT / CA' },
  'sanna-kannisto': { countryCode: 'FI' },
  'santiago-sierra': { countryCode: 'ES' },
  'santos-r-vasquez': { countryCode: 'US' },
  'sara-vanderbeek': { countryCode: 'US' },
  'seung-woo-back': { countryCode: 'KR' },
  'seydou-keita': { countryCode: 'ML' },
  'sergey-bratkov': { countryCode: 'UA' },
  'shannon-ebner': { countryCode: 'US' },
  'sharon-lockhart': { countryCode: 'US' },
  'sherrie-levine': { countryCode: 'US' },
  'shirana-shahbazi': { countryCode: 'IR / CH' },
  'simon-norfolk': { countryCode: 'NG / GB' },
  'simone-nieweg': { countryCode: 'DE' },
  'sonja-braas': { countryCode: 'DE' },
  'sophie-calle': { countryCode: 'FR' },
  'stefan-burger': { countryCode: 'CH' },
  'stephen-gill': { countryCode: 'GB' },
  'stephen-shore': { countryCode: 'US' },
  'sze-tsung-leong': { countryCode: 'US' },
  'tacita-dean': { countryCode: 'GB' },
  'taiji-matsue': { countryCode: 'JP' },
  'takashi-homma': { countryCode: 'JP' },
  'takashi-yasumura': { countryCode: 'JP' },
  'thomas-demand': { countryCode: 'DE' },
  'thomas-ruff': { countryCode: 'DE' },
  'torbjrn-rdland': { countryCode: 'NO' },
  'tracey-moffatt': { countryCode: 'AU' },
  'valerie-belin': { countryCode: 'FR' },
  'viviane-sassen': { countryCode: 'NL' },
  'wang-qingsong': { countryCode: 'CN' },
  'william-christenberry': { countryCode: 'US' },
  'wolfgang-tillmans': { countryCode: 'DE' },
  'xavier-ribas': { countryCode: 'ES' },
  'yang-fudong': { countryCode: 'CN' },
  'yto-barrada': { countryCode: 'MA / FR' },
  'zbigniew-libera': { countryCode: 'PL' },
  'zwelethu-mthethwa': { countryCode: 'ZA' }
};
...
function getPhotographerEnrichment(photographer) {
  ...
  return {
    ...(PHOTOGRAPHER_COUNTRY_OVERRIDES[id] || {}),
    ...(PHOTOGRAPHER_ENRICHMENTS_DATA[id] || {})
  };
}
...
function photographerCountryMeta(photographer) {
  ...
  const label = text ? text[currentLanguage] : fallbackCountryLabel(nationality);
  return { nationality, flag, label };
}

function fallbackCountryLabel(nationality) {
  ...
  return parts
    .map(part => COUNTRY_TEXT[part]?.[currentLanguage] || part)
    .join(' / ');
}
