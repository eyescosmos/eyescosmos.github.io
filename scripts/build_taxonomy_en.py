...
STUB_TO_SLUG = {
    ...
    'ポストインターネット':    'post-internet-photography',
...
SLUG_TO_EN_NAME = {
    ...
    'post-internet-photography': 'Post-Internet Photography',
    'intimate-life':             'Intimate Life',
...
MOVEMENT_ABSTRACTS_EN = {
    ...
    'post-internet-photography': "Practices since the late 2000s that respond to the internet as an everyday condition rather than a novelty, taking the circulation, reproduction, and transformation of images as their subject.",
    'intimate-life':             "A practice that records the inside of private life — family, lovers, friends, and the photographer's own body — as diary-like snapshots grounded in intimacy with the subject. The closeness between the one who photographs and the one who is photographed is itself the form of this lineage.",
...
MOVEMENT_THESES_EN = {
    ...
    'post-internet-photography': "What post-internet photography inverted was <em>the hierarchy between the original and its circulating copies</em> — exhibition documentation, stock imagery, and social-media posts became sites where the work itself takes place.",
    'intimate-life':             "What Intimate Life brought to photography is an ethics in which the photographer is a participant rather than an outsider. As Nan Goldin called The Ballad of Sexual Dependency 'the diary I let people read', the record of private life was presented not as observation but as the coincidence of living and photographing.",
