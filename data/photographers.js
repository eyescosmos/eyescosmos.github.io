const PHOTOGRAPHERS = [
...

  {
    ...
    context: {
      ...
      textEn: 'Martin Parr changed documentary photography by bringing saturated color, electronic flash, and intrusive closeness into the depiction of ordinary British life*1. The Last Resort became a landmark because it mixed satire, affection, vulgarity, and social critique in ways that broke with older documentary seriousness*2. Parr later expanded this approach to global tourism, consumption, and the homogenized rituals of late capitalism, while also becoming one of the great champions of photobook culture*3. His work remains essential for understanding how documentary could become comic, uncomfortable, and brightly colored without losing its critical edge*4.',
      citations: [
