const PHOTOGRAPHERS = [
...

  {
    ...
    context: {
      ...
      textEn: 'Felice Beato was one of the earliest globally mobile photographers, following British and French imperial campaigns from the Crimean War onward*1. After photographing the aftermath of the Indian Rebellion and the Second Opium War, he moved to Yokohama in 1863 with the British illustrator Charles Wirgman and opened the Beato & Wirgman studio*2. Beato understood very clearly what Western travelers wanted to see in the East, and he sold albums of Japanese landscapes, people, and customs while helping to establish the hand-colored album tradition in Japan. His work is therefore a major visual record of the transition from the late Tokugawa period to early Meiji society*1. At the same time, the work is inseparable from imperial power, and it is now often examined critically in that context*2.',
      citations: [
...

  {
    ...
    context: {
      ...
      textEn: 'Gustave Le Gray, trained first as a painter in Paris, turned to photography in the late 1840s and opened the school that helped shape figures such as Nadar*1. His famous seascapes solved a technical problem: a single negative could not properly render both sea and sky, so he combined separate exposures in the darkroom to make images such as The Great Wave*2. He also improved the calotype through the waxed-paper negative process. Financial difficulty forced him out of France around 1860, and he spent the rest of his life in Cairo as a photographer and drawing teacher. Forgotten for a long time, he has since been restored to a central place in nineteenth-century photographic history*1.',
      citations: [
  ...
  /* ────────── 1839–1860s（再掲） ────────── */
  {
    ...
    context: {
      ...
      textEn: 'Mathew Brady became famous through portraits of major American figures and was widely regarded as the leading portrait photographer in the United States*1. At the outbreak of the Civil War, he invested his own fortune in the belief that war had to be photographed, organizing a large team of operators and sending them into the field with mobile darkrooms. Images associated with Brady\'s studio, including those made by Alexander Gardner and Timothy O\'Sullivan, brought the reality of war to the public with unprecedented force*2. When photographs of the dead at Antietam were shown in his New York gallery in 1862, viewers confronted battlefield corpses in a new and shocking way*1. Brady later went bankrupt and died in poverty, which shows both the cultural power and the financial fragility of early war photography*2.',
      citations: [
...

  {
    ...
    thumbnail: '',
    links: [
      { label: 'Metropolitan Museum of Art — Alfred Stieglitz', url: 'https://www.metmuseum.org/essays/alfred-stieglitz-1864-1946-and-american-photography' },
      { label: 'Museum of Modern Art — Alfred Stieglitz', url: 'https://www.moma.org/artists/5664-alfred-stieglitz' },
      { label: 'National Gallery of Art — Alfred Stieglitz Key Set', url: 'https://www.nga.gov/research/publications/alfred-stieglitz-key-set/introduction-key-set' },
      { label: 'J. Paul Getty Museum — Alfred Stieglitz', url: 'https://www.getty.edu/art/collection/person/103KH0' },
      { label: 'Art Institute of Chicago — Alfred Stieglitz Collection', url: 'https://archive.artic.edu/stieglitz/about/' },
      { label: 'Wikipedia (EN)', url: 'https://en.wikipedia.org/wiki/Alfred_Stieglitz' },
      { label: 'V&A — Alfred Stieglitz', url: 'https://www.vam.ac.uk/articles/alfred-stieglitz-pioneer-of-modern-photography' },
    ],
    amazon: '',
    context: {
      text: '1890年代のニューヨークでは写真は「機械的な複写装置」とみなされ、絵画・彫刻と同列の芸術として美術館に展示される対象ではなかった。スティーグリッツが写真の芸術的地位を高めようとしたのは、この文化的偏見と正面から戦うためだった*1。初期のピクトリアリズムの段階では——軟焦点・ゴム重クロム酸塩プリント・絵画的構図——を駆使して「写真も絵画に匹敵する」ことを示そうとした。1902年に結成した写真分離派の目的をスティーグリッツ自身は「ピクトリアル写真に傾倒したアメリカ人たちをまとめ、それが個人的表現の独自媒体として認められるよう努める」と定義した*2。1903年創刊の写真誌『カメラ・ワーク』と1905年開廊のギャラリー291は、写真を絵画と同じ文脈に置く制度的戦略だった。291ではマティス（1908年）・セザンヌ・ピカソ（1911年）らのアメリカ初個展を開催し、前衛絵画と並置することで「写真は芸術か」という問い自体を時代遅れにしようとした*3。しかし第一次世界大戦後、スティーグリッツはピクトリアリズムの方針——絵画を模倣することで芸術性を証明する——が根本的に誤りだと気づいた。モダニズムの核心は「素材固有の特性を尊重する」ことにあり、写真が絵画を真似することはその独自性を自ら否定することだったのである*1。「ストレート写真」への転換後、1922年から始めた「エクイヴァレンツ」では雲の連作約350点を制作し、「写真は被写体によらず内的状態の等価物たりうる」と宣言した*4。この概念が音楽と本質的に結びついていることは、最初の連作タイトル「音楽：十枚の雲の写真の連作」（Music: A Sequence of Ten Cloud Photographs, 1922）と「空の歌」（Songs of the Sky, 1923）に端的に示されている。スティーグリッツはジョージア・オキーフに「作曲家アーネスト・ブロッホがこれを見て『音楽だ！これは音楽だ！』と叫ぶような写真を撮りたい」と語り、実際にブロッホはその通りの言葉を発したと伝えられている*5。この発想は、視覚芸術も音楽のように非再現的で感情を喚起する質を持ちうるという、スティーグリッツ周辺の考え方と結びついていた*5。写真が純粋に抽象的な感情の記録になりうることを、スティーグリッツほど制度・言説・作品の三面から押し出した人物は少ない。V&Aはエクイヴァレンツを「意図的に抽象的な写真作品」の最初期の例として位置づけ、AICもそれを単なる雲の記録ではなく、内的状態の等価物として説明している*2*5。つまり彼の重要性は、美しい雲の写真を撮ったことではなく、写真が対象の説明から離れ、形式・感情・展示制度を通じて自律的な芸術になりうると示した点にある。',
      textEn: `In New York in the 1890s, photography was still widely treated as a mechanical copying process rather than something museums might exhibit beside painting and sculpture. Stieglitz's effort to raise the medium's status began as a direct confrontation with that prejudice*1. In his pictorialist phase he used soft focus, gum bichromate printing, and painterly composition to prove that photographs could rival painting. He defined the Photo-Secession, founded in 1902, as an attempt to unite Americans devoted to pictorial photography and secure recognition for it as a distinct medium of personal expression*2. Camera Work, launched in 1903, and the gallery 291, opened in 1905, were institutional strategies for placing photography in the same cultural frame as modern art. At 291 he mounted the first American exhibitions of figures such as Matisse, Cezanne, and Picasso, effectively making the question "Is photography art?" seem increasingly obsolete*3. After World War I, however, Stieglitz came to see pictorialism's basic premise as flawed: if modernism meant respecting the inherent properties of each medium, then photography could not justify itself by imitating painting*1. In the move toward straight photography, his Equivalents series, begun in 1922, produced roughly 350 cloud studies and proposed that photography could become an equivalent of inner feeling rather than merely a record of external subjects*4. The musical dimension of this idea is inscribed in the early series titles themselves: Music: A Sequence of Ten Cloud Photographs (1922) and Songs of the Sky (1923). Stieglitz told Georgia O'Keeffe that he wanted to make photographs which, when the composer Ernest Bloch saw them, would make him exclaim "Music! Music! Man, why that is music!" — and when Bloch did see them, that was precisely what he said*5. The idea belonged to a broader belief in Stieglitz's circle that visual art could take on the nonrepresentational, emotionally evocative qualities of music*5. These pictures were among the first sustained claims that photography could register abstract emotional states rather than merely document the world. The V&A describes the Equivalents as some of the first intentionally abstract photographic works, while the Art Institute of Chicago reads them not as simple records of clouds but as equivalents of the artist's inner state*2*5. Stieglitz's importance, then, lies not only in the beauty of the cloud pictures but in the way he joined image, institution, and argument to show that photography could become an autonomous modern art.`,
      citations: [
        ...
        { num: 3, name: 'National Gallery of Art — The Key Set: 1902–1917', url: 'https://www.nga.gov/research/publications/alfred-stieglitz-key-set/key-set-1902-1917' },
        { num: 4, name: 'National Gallery of Art — The Key Set: 1918–1937', url: 'https://www.nga.gov/research/publications/alfred-stieglitz-key-set/key-set-1918-1937' },
...

  {
    ...
    thumbnail: '',
    links: [
      { label: 'Museum of Modern Art — László Moholy-Nagy', url: 'https://www.moma.org/collection/artists/4048' },
    ...
    context: {
      ...
      citations: [
        ...
        { num: 4, name: 'Museum of Modern Art — László Moholy-Nagy', url: 'https://www.moma.org/collection/artists/4048' },
...

  {
    ...
    links: [
      ...
      { label: 'J. Paul Getty Museum — Albert Renger-Patzsch', url: 'https://www.getty.edu/art/collection/person/103KHR' },
      { label: 'Museum of Modern Art — Albert Renger-Patzsch', url: 'https://www.moma.org/artists/4866-albert-renger-patzsch' },
      { label: 'Tate — Albert Renger-Patzsch', url: 'https://www.tate.org.uk/art/artists/albert-renger-patzsch-2709' },
      { label: 'George Eastman Museum Collections Online — Albert Renger-Patzsch', url: 'https://collections.eastman.org/people/66942/albert-rengerpatzsch/objects' },
      { label: 'National Gallery of Art — Albert Renger-Patzsch', url: 'https://www.nga.gov/artists/13554-albert-renger-patzsch' },
    ],
    amazon: '',
    context: {
      text: 'アルベルト・レンガー＝パッチュは1920年代のドイツで、ピクトリアリズムとバウハウス系実験写真の双方に距離を置く第三の路線を切り開いた。ピクトリアリズムが写真を絵画的に「美化」し、バウハウスが写真を視知覚変革の道具とみなしたのに対し、レンガー＝パッチュは「物それ自体の構造的な美しさをそのまま示す」という立場をとった*1。1928年刊行の写真集は工場の煙突・鉄道橋・植物の細部・陶磁器の反射・鋳物工具など100点を収録したものだが、本人が意図したタイトルは「物」であり、出版社エルンスト・ヴァスムートが商業的理由から「世界は美しい（Die Welt ist schön）」に変更したという経緯がある*2。この刊行は批評家ヘルムート・ゲルンスハイムが「ドイツ近代写真の転換点」と評し、トーマス・マンは公開の場で絶賛した*3。ヴァルター・ベンヤミンは1931年の論考「写真の小史」で「物に宇宙的な意味を持たせることができるが、人間の社会的条件については沈黙している」と批判した——政治的・社会的文脈を排した「物の美しさ」への集中への正面からの異議申し立てだった*4。レンガー＝パッチュが実践した「物の写真」は対象の形・質感・光を最大限の技術的精度で記録する手法であり、ザンダーが社会の総体を記録しようとしたのに対し、個別の事物の視覚的純度にこだわった点で対照的だった。ザンダーが人物の類型記録を、ブロッスフェルトが植物のマクロ拡大写真を担ったのと並び、レンガー＝パッチュが工業形態と日用物品を記録する——この三者が新即物主義写真の三本柱をなした*3。彼が植物撮影から培ったマクロ接写の技法——被写体に極限まで接近し精密な光学系で素材の肌理・反射・微細な構造を引き出す——は工業製品にも等しく適用され、肉眼では見過ごされる「物の内的秩序」を浮かび上がらせた*2。1944年の連合軍爆撃でゾースト近郊のアトリエが壊滅しコレクションの大部分を失ったが、戦後はルール地方の鉱山・製鉄所を精力的に撮影し続けた*5。彼のアプローチはドイツ産業写真・製品広告の美学的基盤となり、ベッヒャー夫妻による工業建築の類型的記録の源流の一つとして位置づけられている*6。',
      textEn: 'Albert Renger-Patzsch opened a third path in 1920s Germany, distancing himself from both pictorialist beautification and Bauhaus-style experimental photography. Where pictorialism made photographs painterly and Bauhaus photography treated the camera as a tool for transforming visual perception, Renger-Patzsch argued for showing the structural beauty of things themselves*1. His 1928 photobook gathered one hundred images of factory chimneys, railway bridges, plant details, ceramic reflections, cast-metal tools, and other objects. The title he wanted was simply Things; the publisher Ernst Wasmuth changed it for commercial reasons to Die Welt ist schön, The World Is Beautiful*2. The book was quickly received as a landmark. Helmut Gernsheim later described it as a turning point in modern German photography, and Thomas Mann publicly praised it*3. Walter Benjamin, however, objected in his 1931 essay A Short History of Photography that this photography could give things cosmic significance while remaining silent about the social conditions of human beings. His criticism directly challenged the work\'s concentration on the beauty of objects stripped of political and social context*4. Renger-Patzsch\'s photography of things recorded form, texture, and light with maximum technical precision. In contrast to August Sander, who tried to describe society as a whole, Renger-Patzsch pursued the visual purity of individual objects. Together with Sander\'s typological portraits and Karl Blossfeldt\'s magnified plant studies, his photographs of industrial forms and everyday manufactured things became one of the three pillars of New Objectivity photography*3. The macro close-up technique he developed through botanical work, pushing proximity and optical precision to reveal grain, reflection, and minute structure, was applied just as strongly to industrial products. It made visible an inner order of things that ordinary sight tends to overlook*2. Allied bombing in 1944 destroyed his studio near Soest and much of his collection, but after the war he continued to photograph mines and steelworks in the Ruhr with great energy*5. His approach became a foundation for the aesthetics of German industrial photography and product advertising, and it is also understood as one of the sources for Bernd and Hilla Becher\'s typological documentation of industrial architecture*6.',
      citations: [
        ...
        { num: 2, name: 'Museum of Modern Art Object:Photo — Die Welt ist schön', url: 'https://www.moma.org/interactives/objectphoto/publications/780.html' },
        { num: 3, name: 'Aperture Archive — Albert Renger-Patzsch', url: 'https://archive.aperture.org/article/1993/2/2/albert-renger-patzsch-3' },
        ...
        { num: 6, name: 'Getty Publications — The Absolute Realist: Collected Writings of Albert Renger-Patzsch, 1923–1967', url: 'https://shop.getty.edu/collections/getty-publications/products/the-absolute-realist-collected-writings-of-albert-renger-patzsch-1923-1967-978-1606067802' }
      ]
    }
  },
  /* ─────────────────────────────────────────
...

  {
    ...
    context: {
      ...
      textEn: `Walker Evans photographed rural poverty in the American South for the Farm Security Administration from 1935 to 1937, yet he kept a deliberate distance from the agency's propagandistic purpose. So ill-suited was he to overt political messaging that contemporaries remarked one could hardly imagine anyone less fit for propaganda work. Rather than illustrate policy, he pursued what he called the essential distillation of American everyday life, using an 8x10 camera, exact composition, and available light*1. He often ignored assigned routes in order to pursue his own subjects, from gas stations and storefront signs to Victorian houses. In 1938, MoMA gave Evans the museum's first solo exhibition devoted to a photographer, American Photographs, and published an accompanying book with an essay by Lincoln Kirstein. It stands as one of the key moments in the museum legitimation of photography as fine art*2. His collaboration with James Agee among white sharecroppers in Alabama failed to appear in magazine form and only reached the public in 1941 as Let Us Now Praise Famous Men, a book initially neglected and later canonized as a major work of American literature*3. Evans insisted on presenting pictures with minimal captioning, often confining explanatory text to the ends of sections in a book, because he believed photographs should meet viewers before language organizes them. In his subway portraits, made secretly in New York between 1938 and 1941 and published in 1966, he used a concealed camera to register anonymous fellow passengers as if their faces held compressed fragments of social reality*4. After 1945 he worked for two decades as a photo editor at Fortune and later taught at Yale. The poetry in Evans's pictures lies not in manipulation but in selection and framing: signs, worn walls, or the faces of tenant farmers are made to feel as if the present has already slipped into history. The Metropolitan Museum of Art has described this as a photographic equivalent of literary lyricism, irony, and narrative structure*1. His phrase "literal, documentary, style, lucid, severe, direct" became an influential paradoxical model for later American photographers from Robert Frank to Lee Friedlander*5.`,
      citations: [
...

  {
    ...
    context: {
      ...
      textEn: `Henri Cartier-Bresson encountered Surrealism from 1926 onward and, through Rene Crevel, came into contact with Andre Breton. He brought Surrealism's attention to the dreamlike charge hidden within ordinary reality into photography, and from the moment he picked up a Leica in 1931 he rejected retouching and cropping, making the simultaneous grasp of form and event inside the viewfinder his central principle*1. His well-known formulation - the simultaneous recognition, in a fraction of a second, of the significance of an event and of the precise organization of forms that give it expression - remains the core of his photographic thought*2. Taken prisoner by the German army in 1940, he spent three years in a camp before escaping on his third attempt in 1943. Back in France, he documented the liberation of Paris and also worked with Jean Renoir. In 1947 he co-founded Magnum Photos with Robert Capa, David Seymour, George Rodger, and William Vandivert. Magnum was the first major photo agency built around photographers retaining copyright and editorial control while reporting the world's decisive events independently of any single magazine*3. His 1952 French book Images a la Sauvette appeared in English as The Decisive Moment, with a cover by Henri Matisse. As a Magnum photographer he covered Indian independence, Gandhi's assassination, and the Chinese Revolution, helping set the aesthetic and ethical terms of postwar photojournalism*4. In 1955 he became the first photographer to be granted an exhibition in the Louvre, a symbolic milestone in photography's acceptance as fine art. After 1975 he largely withdrew from photography to focus on drawing, and in 2003 he established a foundation in Paris to preserve his work*5. His commitment to the poetry of the instant over technical display, along with his refusal to use flash because he believed artificial light killed that poetry, made him a foundational figure for generations of street photographers around the world.`,
      citations: [
...

  {
    ...
    context: {
      ...
      textEn: 'W. Eugene Smith helped define the modern photo essay at LIFE by turning long periods of immersion with his subjects into narrative picture stories rather than isolated news images*1. For Smith, documentary work was not neutral description but a moral cry, which is why projects such as Country Doctor became landmarks in photojournalism*3. His constant battles with editors over control of his images eventually pushed him away from magazine journalism and into larger independent projects, including the vast Pittsburgh essay*2. In the 1970s his work in Minamata, Japan, transformed industrial pollution into a global visual indictment, and his photograph of Tomoko Uemura in her bath became one of the most powerful environmental images of the century*4. Smith remains central to the idea that documentary photography can be narrative, partisan, and ethically charged at the same time*5.',
      citations: [
...

  {
    ...
    context: {
      ...
      textEn: `Robert Frank was born into a Swiss Jewish family in Zurich and moved to New York in 1947, where he initially found work in fashion photography for Harper's Bazaar. Yet the real subject of his photography was not fashion but the America he saw as an immigrant outsider, what lay beneath its public surface*1. In 1954, with a recommendation from Walker Evans describing him as the most talented of the younger photographers, Frank received a Guggenheim Fellowship and spent two years making more than 28,000 exposures across the United States. His experience of being stopped and detained in Arkansas because of his appearance and foreign accent sharpened the outsider perspective that runs through the work*2. From those thousands of images he selected eighty-three for The Americans, first published in France in 1958 and then in the United States the following year with an introduction by Jack Kerouac, who famously wrote that this shy, pleasant Swiss with a little camera had absorbed the sad poem of America into film*3. Contemporary magazines such as Popular Photography attacked the book's blur, grain, rough exposure, and tilted horizons as incompetence, but later critics would call it perhaps the most influential photobook of the twentieth century*4. What Frank refused was the bright, orderly, optimistic visual language of 1950s LIFE magazine, with its carefully composed images of prosperity and national cohesion. His photographs instead registered segregation, loneliness, and inequality with the peculiar closeness and distance of someone who did not entirely belong*2. Though poorly received at first, the book was radically revalued in the 1960s as civil rights struggle and antiwar protest made its bleak vision of America newly legible. ICP has called The Americans one of the most revolutionary books in photographic history, and it became a touchstone for later photographers such as Garry Winogrand, Lee Friedlander, Danny Lyon, and Joel Meyerowitz*2. After publishing the book, Frank moved increasingly into documentary filmmaking, including Pull My Daisy (1959), made with writers and poets of the Beat generation*5.`,
      citations: [
...

  {
    ...
    amazon: '',
    context: {
      text: 'ダイアン・アーバスは1923年ニューヨーク生まれ。父が5番街の高級毛皮・百貨店「ラセックス」を経営する裕福なユダヤ系家庭に育ち、大恐慌の影すら届かない隔絶した環境の中で過ごした。「私は免疫を与えられ、あらゆる状況から守られて育った。子供の頃に苦しんだことがあるとすれば、逆境をまったく感じたことがないということだった」という自己認識は、彼女の生涯を貫く動機の核心をなす*1。18歳でアラン・アーバスと結婚し、1950年代は夫婦でヴォーグ・ハーパーズ・バザーのファッション写真を担当したが、この「美しいものだけを見せる」商業写真に深い閉塞感を覚えた。転機は1956年頃、リゼット・モデルのニュースクール・フォー・ソーシャル・リサーチの授業への入門だった。モデルの教えの核心は「gut（はらわた）で撮れ」——理性ではなく本能と情動に従い、自分が本当に惹きつけられるものへ直進せよというものだった*1。元夫アラン・アーバスは「3回の授業でダイアンは写真家になった」と語っている。モデルの薫陶のもとでアーバスが自らのものとした命題が「恐怖こそ撮るべきものだ（Take pictures of what you fear）」であり、これは1971年の授業記録を基に死後1972年にアパーチャーが刊行したモノグラフに収録されている*5。この命題の根には、幼少期の「禁じられた視線」があった——障害者や社会の周縁にいる人を見てはいけないという暗黙の規範が、逆にそこへのとめどない惹きつけを生んだのだった。彼女の撮影行為は、見てはいけないとされたものを正面から見る行為であり、その恐怖を通過することで自らの出自の特権性を贖おうとする試みでもあった。フリークスについて彼女はこう語った——「ほとんどの人は人生でトラウマ的な体験をすることを恐れながら生きている。フリークスは最初からトラウマとともに生まれた。彼らはすでに人生の試練を乗り越えた貴族たちだ」（1972年アパーチャー・モノグラフ）*5。サーカス・精神病院・ヌーディストキャンプ・タイムズスクエアのトランスベスタイト・バーへ足を運び、被写体と長期にわたる関係を築いてから正面から撮影するという手法は「写真家と被写体の間の適切な距離」という慣習を根本から覆した。「カメラは、行きたい場所へ行き、やりたいことをする許可証だった」と彼女は語っている。1963年・1966年にグッゲンハイム・フェローシップを連続受賞。1967年MoMAの「ニュー・ドキュメンツ」展（フリードランダー・ウィノグランドとともに）でザルコウスキーに「ドキュメンタリー写真をより個人的な目的に向け直した」写真家として位置づけられた*2。同年の代表作「双子（ニュージャージー州ロゼル、1967年）」はシカゴ美術館等に収蔵されている*3。ICPは彼女を「写真の語り方を変えた人物」と記録する*4。1971年7月に48歳で死去。翌1972年にはヴェネツィア・ビエンナーレに作品が展示された最初のアメリカ人写真家となり、同年アパーチャー財団がドゥーン・アーバスとマービン・イズラエル編集による遺作集を刊行した*5。',
      textEn: 'Diane Arbus grew up in a prosperous Jewish family on Manhattan\'s Central Park West, insulated from the Depression and from any direct encounter with hardship or difference. "I grew up feeling immune and exempt from circumstance," she wrote. "One of the things I suffered from was that I never felt adversity." That sense of having been quarantined from the texture of real life became the driving force of her practice*1. After years making fashion photographs for Vogue and Harper\'s Bazaar alongside her husband Allan Arbus, she enrolled in Lisette Model\'s classes at the New School for Social Research around 1956. Model\'s core teaching was "shoot from the gut" — trust instinct, go directly toward what compels you — and it converted Arbus\'s fear into a stimulus. Allan Arbus later said: "Three sessions and Diane was a photographer." The principle Arbus made her own was "Take pictures of what you fear," recorded in her 1971 class remarks and compiled in the posthumous Aperture monograph*5. The camera, she said, was "a license to go wherever I wanted and to do what I wanted to do." In practice this meant sustained visits to circuses, nudist camps, mental institutions, and the transvestite bars of Times Square — places her upbringing had forbidden her even to look at. She returned repeatedly to the same subjects over months and years, building the trust that made her close, frontal portraits possible. About the people she called freaks she wrote: "Most people go through life dreading they\'ll have a traumatic experience. Freaks were born with their trauma. They\'ve already passed their test in life. They\'re aristocrats"*5. In New Documents at MoMA in 1967, John Szarkowski placed her alongside Lee Friedlander and Garry Winogrand as photographers redirecting documentary toward personal vision rather than social reform*2. The Identical Twins, Roselle, N.J. (1967) became one of the defining images of a new portraiture*3. ICP records her as someone who changed the way photography speaks*4. She died in 1971; the following year her work appeared at the Venice Biennale — the first American photographer to be included — and the Aperture monograph, edited by Doon Arbus and Marvin Israel, established her posthumous reputation worldwide*5.',
      citations: [
...

  {
    ...
    amazon: '',
    context: {
      text: '森山大道は1938年大阪府池田市生まれ。父の職業柄、幼少期から東京・広島・千葉・島根・大阪と各地を転々とした放浪の生い立ちが、後の「さすらう眼差し」の原型となった。岩宮武二・細江英公のアシスタントを経て1961年に独立するが、個人的・即興的な路線へと向かわせた決定的な契機はウィリアム・クラインの写真集との出会いだった。「巨大なショックだった」と森山自身が語ったクラインの粗粒子でエネルギッシュなストリート写真は、写真が客観的記録ではなく生々しい衝突の痕跡でありうることを示していた*1。1968年創刊の写真誌「プロヴォーク」（中平卓馬・多木浩二・岡田隆彦らが「思想のためのちょうはつてき資料」を副題に創刊）に第2号から参加した森山が実践した「アレ・ブレ・ボケ」——粗い粒子・手ブレ・ピントのずれ——の美学は、単なる技法上の実験ではなかった。その背景には二重の否定があった。第一に、1960年の安保闘争の挫折と1968年の全共闘運動の高揚という文脈で、政治的言語がことごとく信頼を失い、「言葉で表現できないものを写真が捕捉すべき」という切迫した問題意識があった。第二に、さらに根本的な認識——整然とした「鮮明な写真」は現実を捏造しうるという不信感だった。日本の写真家たちが戦時中に帝国主義的プロパガンダを支持する作品を大量に制作していたという歴史への対峙から、「写真が現実を表現できる」という信念そのものが危険な道具になりうることをプロヴォークの参加者たちは認識していた*2。粒子・ブレ・ピントのずれという「不完全さ」は欠如ではなく、理性的な制御や意味の確定を拒む感覚の誠実な痕跡を選びとる行為だった。「私が街に出ていく時、計画はない。ある通りを歩き、別の角を曲がりたいと感じたら曲がる。本当に、私は犬のようなものだ——どこへ行くかを、物の匂いによって決める」という自己記述は1971年の代表作「三沢の野良犬」に直結し、思想や言語ではなく身体と衝動に写真行為の根拠を置く立場を示している。また「コピーのコピー」という概念——自らをそう定義する視点——はアンディ・ウォーホルの複製思想と交差しながら、写真家の固有性よりも複製と流通のプロセスそのものに意味を見出す姿勢を示す。1972年の写真集「写真よさようなら」は他の芸術家の作品や切り取ったネガを混在させ著者性とスタイルを解体しようとした試みであり、テート・ギャラリーのコレクションに収蔵されている*3。欧米写真批評における位置づけは、1974年にMoMAの写真部長ジョン・ザルコウスキーが企画した「新日本写真展」から始まる。ザルコウスキーは「東松照明の仕事に潜むニヒリズムの示唆が、森山によってあけすけかつ効果的に明示化された」と論じ、森山を新世代日本写真の中心に位置づけた*6。1999年にはSFMOMAが「Daido Moriyama: Stray Dog」を開催し、米国一流美術館が日本人写真家に与えた最初の本格的回顧展となった。アパーチャー誌は「戦後日本を描写するというラベルは表面を引っかくだけ」であり、彼の真の関心は「イメージをその本質へと解体すること」にあると論じた*7。2012〜13年のテート・モダンでのウィリアム・クラインとの二人展では批評家サラ・ケントが「森山は西洋写真家の信者としてではなく、それ自体として評価されるべきだ」と主張した*2。2019年にはハッセルブラッド財団国際写真賞を受賞し「史上最も重要で影響力ある写真家の一人」と評された*4。MoMAも恒久コレクションに収蔵しており*5、そのアレ・ブレ・ボケの美学はウォルフガング・ティルマンスら後続世代に広く影響を与えている。',
      textEn: `Daido Moriyama was born in Ikeda, Osaka, in 1938 into a family whose frequent moves — Tokyo, Hiroshima, Chiba, Shimane, Osaka — gave him what he later described as an instinct for wandering that became foundational to his practice. After assisting Takeji Iwamiya and Eikoh Hosoe, the decisive turn toward a personal and improvisational approach came through his encounter with William Klein's photobooks. "A huge shock," he called it: Klein's rough, aggressive pictures of city life showed that photography could be a record of collision rather than calm observation, and that directness was more honest than polish*1. He joined Provoke magazine from its second issue in 1968. The magazine's subtitle — "provocative materials for thought" — expressed a precise critical position: political language had failed after the collapse of the 1960 Anpo security treaty struggle, and clean, well-made images were suspect because Japanese photographers had used them to support imperial propaganda during the war. A sharp, composed photograph could lie; grain, blur, and lost focus could not*2. The are-bure-boke aesthetic — grainy, blurred, out of focus — was therefore not a stylistic preference but an ethical claim: the only honest image was one that showed the limits of the photographer's control, a trace of a body moving through a world that resisted rational ordering. Moriyama described his approach in terms of instinct rather than method: "When I go out into the street, I have no plan. I walk down one street and feel like turning a corner, so I turn. I am really like a dog — I decide where to go by the smell of things." This connects directly to his best-known single image, Stray Dog, Misawa (1971)*3. His concept of "copy of a copy" — drawn partly from Warhol — placed the emphasis not on the photographer's unique vision but on the circulation of images as a cultural process. Farewell Photography (1972), which mixed his own images with those of other artists and cropped negatives, pushed the dismantling of authorship as far as it could go; it later entered the Tate collection*3. His international reputation was shaped by a sequence of institutional moments: John Szarkowski's New Japanese Photography at MoMA in 1974, where Szarkowski wrote that what was nihilistic suggestion in Tomatsu became in Moriyama "frank and effective statement"; the first major American museum retrospective at SFMOMA in 1999; and Aperture's argument that the label "postwar Japan" only scratches the surface, and that his real concern was dismantling the image itself*6. A 2012-13 Tate Modern exhibition pairing him with William Klein drew the response from critic Sarah Kent that Moriyama "deserves to be seen as a law unto himself, rather than an acolyte of a more familiar western photographer"*2. In 2019 he received the Hasselblad Award, whose jury chair described him as one of the most important and influential photographers in history*4. MoMA holds his work in its permanent collection*5.`,
      citations: [
        ...
        { num: 6, name: 'SFMOMA — Distant Relations: Japanese Photography in American Exhibitions in the 1970s', url: 'https://www.sfmoma.org/essay/distant-relations-japanese-photography-in-american-exhibitions-in-the-1970s/' },
        { num: 7, name: 'Aperture — Why Daido Moriyama&#39;s Radical Vision Is Misunderstood', url: 'https://aperture.org/editorial/why-daido-moriyamas-radical-vision-is-misunderstood/' }
      ]
    }
  },

  {
    ...
    amazon: '',
    context: {
      text: 'シンディ・シャーマンは1954年ニュージャージー生まれ。1977年から1980年にかけて制作した69点の黒白写真シリーズ「アンタイトルド・フィルム・スティルズ」は、1950〜60年代のハリウッド映画・フィルム・ノワール・ヨーロッパ芸術映画のスチール写真を模倣しているように見えながら、実際には存在しない映画の一場面として虚構の重層構造を持つ。シャーマン自身が監督・モデル・スタイリスト・撮影のすべてを担い、イングニュー・働く女性・ヴァンプ・孤独な主婦などの典型的な女性像を演じた*1。MoMAは1995年に69点の全シリーズを収蔵し、翌1996〜97年に完全展示を実施した*2。このシリーズは「ピクチャーズ・ジェネレーション（Pictures Generation）」の中核的作品として位置づけられる。ピクチャーズ・ジェネレーションとは、1977年にダグラス・クリンプがニューヨークのアーティスツ・スペースで企画した「ピクチャーズ」展（トロイ・ブロントゥック・ジャック・ゴールドスタイン・シェリー・レヴァイン・ロバート・ロンゴらが参加）を起点に生まれた批評的概念で、「ポップ・カルチャーの既成イメージを流用することで写真の意味が他の表象との関係から生まれることを示す」というクリンプの理論が核をなす*3。シャーマンは当初のメンバーではなかったが、この枠組みへの中核的参加者として認められ、2009年のメトロポリタン美術館の大規模展でも中心に据えられた。「大量に流通するイメージの中に内在する権力構造を可視化する」とはこういうことだ——フィルム・スティルズは実在しない映画のスチール写真のように見えるが、これによって映画が作り上げてきた「女性らしさ」のイメージが自然なものではなく文化的に構築されたスクリプトであることが露わになる。フィルム批評家ローラ・マルヴェイは「女性が男性の視線の客体として提示されるという映画の形式的構造そのもの（スコポフィリア的なまなざし）を、シャーマンの作品はパロディとして解剖している」と論じた。批評家クレイグ・オーウェンズはシャーマンを「既成のイメージを没収し、そこに批判的な意味の層を付け加えることで元のイデオロギー的機能を置換するポストモダンの寓意作家」として位置づけた*3。「ポストモダン写真の揺るぎない礎石」と評価される理由は三点に集約される。第一に、オリジナリティではなく流用：既存の映像規範を再コード化するという身振りが、本物の自己表現を理想とするモダニズムへの根本的な拒絶を示す。第二に、アイデンティティの不安定性：「自己同一性は社会的規範と個人的意図の間の不安定な妥協にすぎない」ことを繰り返し実演する。第三に、写真の真実要求への問い：現実を映すとされるメディアを使って明白に構築されたイメージを作ることで、写真のドキュメンタリー的前提を逆用する*5。ローラン・バルトの理論との親和性はとくに「作者の死」（1967年）にある——バルトは作品の意味は作者の意図ではなく読者が構築すると論じたが、シャーマンはペルソナの背後に安定した作者的主体を完全に消去することでこれを構造として実現する。ジャック・ラカンとの親和性は「鏡像段階」と「まなざし」の理論にある。ラカンにとって自我は鏡のイメージとの出会いを通じて形成されるが、その認識は常に誤認（自己よりも統一されたイメージへの同一化）であり、シャーマンの作品はこの誤認を逐語的に反復する。またラカン的なまなざしにおいて対象もまた見返す——シャーマンの各ペルソナが鑑賞者を見返す不穏さは、観者が視覚的支配の幻想を持てなくなる効果をもたらす。批評家ロザリンド・クラウスは1993年の著作でシュミュラクル（原本なきコピー）とラカン理論を組み合わせてシャーマンを論じた。1981年の「アンタイトルド #96」（センターフォールズシリーズ）は2011年クリスティーズで389万ドルの当時写真最高額を記録した*4。2012年MoMAで約170点を展示する大規模回顧展が開催された。',
      textEn: `Born in New Jersey in 1954, Cindy Sherman made her Untitled Film Stills between 1977 and 1980, a series of sixty-nine black-and-white photographs that seem to belong to 1950s and 1960s Hollywood movies, film noir, and European art cinema. Sherman acted as director, performer, stylist, and photographer all at once, staging herself as types such as the ingénue, the working woman, the vamp, or the lonely housewife*1. It remains the only major series she made outside the studio. Each photograph looks like a still from a film that does not actually exist, which gives the work its layered fiction. MoMA acquired the full set in 1995*1 and organized a complete exhibition of the series in 1996-97*2. The Film Stills are now understood as a foundational work of the Pictures Generation that emerged in late-1970s New York. Alongside artists such as Richard Prince, Sherrie Levine, and Robert Longo, Sherman used pre-existing image codes from mass media to expose the structures of power embedded in the pictures that circulate everywhere*3. Feminist criticism has treated the work as a dismantling of the mechanism through which women are offered up as objects for the gaze. Her 1981 Untitled #96, from the Centerfolds series originally commissioned by Artforum, set a then-record price for a photograph at Christie's in 2011*4. MoMA now holds dozens of her works*5, and Sherman is widely regarded as one of the essential figures of postmodern photography. Across later series such as Centerfolds, History Portraits, Disaster, and Sex Pictures, she continued to make performance, masquerade, and the instability of identity her central subject. By using herself while simultaneously withholding any stable "self," Sherman produced a practice that has been discussed not only in art history but also through theoretical frames associated with thinkers such as Roland Barthes and Jacques Lacan. A major MoMA retrospective in 2012 confirmed the scale of that achievement.`,
      citations: [
