const PHOTOGRAPHERS = [
...

  {
    ...
    amazon: '',
    context: {
      text: 'W・ユージン・スミスは1948年から1956年にかけて『ライフ』誌でフォト・エッセイという形式を確立した。1948年刊行の「カントリー・ドクター」はコロラド州の農村医師アーネスト・チェリアーニの日常を12日間追ったもので、写真ジャーナリズム史上最初の本格的なフォト・エッセイとして評価されている*1。スミスは「写真の使用方法に関する編集権」を巡って『ライフ』誌と繰り返し衝突し、計2度退社した。これは「写真家が撮影だけでなく、その写真がどのような文脈で使用されるかに責任を持つべきだ」という主張によるものだった。1955年にマグナムに参加し、ピッツバーグを主題とした大規模な都市記録プロジェクトに着手。当初3カ月の契約だったが強迫的なまでの徹底さで3年間に延長され、17,000点の写真とオーディオ記録を残した*2。1971年、水俣病患者の家族からの連絡を受けてアイリーン・三重子とともに水俣市に移住し、当初3カ月の予定だった滞在が3年に及んだ。水銀汚染による神経障害を全身に負った胎児性水俣病患者の桐野智子（とも子）を風呂に入れる母の写真「入浴する智子と母」（1971年12月撮影）は1972年に『ライフ』誌に掲載され、チッソの産業公害を世界に訴える象徴的な作品となった*3。1972年、チッソ幹部との交渉に患者家族と同行したスミスは、会社が雇った暴力団員に殴打されて意識を失い、右目の視力を永続的に損傷した。この暴行の事実は水俣病問題を国際的に広める契機となり、スミスの写真は裁判の証拠として機能し、チッソが被害者への損害賠償責任を負った日本初の公害訴訟の成立に寄与した*4。「真実を偏見とせよ」というスミスの言葉は、フォト・エッセイが単なる記録を超えて道徳的・政治的な主張になりうるという彼の立場を示している*5。',
      citations: [
...

  {
    ...
    amazon: '',
    context: {
      text: 'ロバート・フランクはスイス・ユダヤ系家庭にチューリッヒで生まれ、1947年にニューヨークへ移住してハーパーズ・バザーのファッション写真家として働き始めた。しかし自身の写真的衝動はファッションではなく、移民の外国人として見るアメリカの「表面の下」にあった*1。1954年、ウォーカー・エヴァンズの推薦状（「今日の若手写真家の中で最も才能がある」）を添えてグッゲンハイム・フェローシップに申請し採択され、2年間で28,000枚以上を撮影した。アーカンソー州では汚れた服と外国語なまりを理由に警察に数時間拘束されるなど、アウトサイダーとしての体験が写真の視点に深く刻まれた*2。28,000枚から83枚を選んで構成した写真集『アメリカン』は1958年にフランスで出版され、翌年の米国版序文をビート作家ジャック・ケルアックが担当した。ケルアックは「小さなカメラを持ったスイス人、控え目で感じのよいロバート・フランクは、フィルムにアメリカの悲しい詩を吸い取り、世界の悲劇的詩人の仲間入りを果たした」と書いた*3。当時の主要写真誌『ポピュラー・フォトグラフィー』は「無意味なブレ・粒子・泥んこの露出・酔っ払いのホリゾン・全般的な杜撰さ」と批判したが、評論家ショーン・オハガンは後年「20世紀で最も影響力のある写真集かもしれない」と評価した*4。フランクの外国人の目は、当時の主要メディアが提示していた「豊かで健全なアメリカ」の像の裏にある貧困・人種差別・孤独を可視化した。写真集刊行後はドキュメンタリー映画制作に移行し、ビート世代の作家・詩人たちとの共同作「プル・マイ・デイジー」（1959年）を制作した*5。彼の粒子の粗い・手ぶれした・斜めの構図という方法論は、写真の「正しい技術」への反抗として、ストリート写真の美学を根本から変えた。',
      citations: [
...

  {
    ...
    amazon: '',
    context: {
      text: 'ウィリアム・クラインはニューヨーク生まれだが、除隊後のパリでフェルナン・レジェのもとで絵画を学び、エルスワース・ケリーやジャック・ヤングマンらアメリカ人画家と交流した。1954年にヴォーグ誌のアート・ディレクター、アレクサンダー・リーバーマンの目に留まり、ニューヨーク帰任とともに同誌の写真家として招かれた*1。1954–56年のニューヨーク滞在中に撮影した写真をまとめた写真集『ニューヨーク、人生は善く、善くあなたのために』（1956年）は、フランスで刊行されプリ・ナダール賞（1957年）を受賞したが、米国の出版社はマンハッタンの汚い側面への視線を嫌って長年拒絶し続けた*2。クラインは高速フィルム・高コントラスト・粒子・ブレ・広角レンズ・挑発的な密着クローズアップという技法を、「欠点」としてではなく「都市のエネルギーを写真に転換する言語」として意図的に選択した。「カメラでしかできないこと——粒子・コントラスト・ブレ・歪んだフレーミングなど——を探求した。写真のルールは私には関係なかった。私は外からやってきた」と語っている*3。1955年からヴォーグ誌で10年間ファッション写真を担当し、モデルをスタジオから街頭に連れ出すという革新的な手法でファッション写真の概念を変えた。ロバート・フランクの『アメリカン』（1958年）と並んで、クラインの1956年の写真集は「20世紀で最も重要な写真集の一つ」として位置づけられている*4。後年は映画監督としても活躍し、1966年に『フー・アー・ユー、ポリー・マグー？』を発表するなど多彩な活動を続け、2022年に96歳で死去した*5。彼の方法論はその後の1960年代ストリート写真家たちの先駆となっており、フランクとともに「写真の正統派技法への反抗」という流れを作った重要人物として評価されている。',
      citations: [
...

  {
    ...
    amazon: '',
    context: {
      text: '荒木経惟は電通の広告写真家として働く傍ら、同社の秘書として働いていた青木陽子（ヨーコ）と1971年7月7日に結婚した。その新婚旅行（柳川・九州）で撮影した写真を私家版写真集『センチメンタルな旅』（1971年）として自費出版したのが、彼の写真家としての出発点となった*1。この写真集はホテルの朝食・窓からの景色・駅・街の風景・ヨーコとの私的な場面を日常スナップの形式で収録したもので、「私的な最も内密な記憶の公開」という行為そのものをアート実践として提示した*2。荒木は自らの写真スタイルを「私写真」と名付け、自身の生活と体験への揺るぎない集中——しばしば性的な内容を含む——を特徴とした。当時のプロヴォーク運動（中平卓馬・森山大道ら）の反乱精神と共鳴しながらも、「私は正式に参加できなかったが、反乱の精神は共有した」と語っている*3。1968年の出会いから1990年にヨーコが卵巣癌で死去するまで、ヨーコは荒木の最も重要な被写体であり続け、その後も「冬の旅」など続篇を発表することで愛・生・喪失という弧を写真で描き続けた*4。70,000点以上の写真集（100冊超）を刊行し、私的な記録と写真芸術の境界を問い続けた写真家として国際的に評価されている*5。',
      citations: [
...

  {
    ...
    amazon: '',
    context: {
      text: 'リー・フリードランダーはワシントン州アバディーン生まれで、1953年からロサンゼルスのアート・センター・スクールで写真を学び、1956年からニューヨークを拠点にエスクァイア・スポーツ・イラストレイテッドなど雑誌の仕事を手がけた。1948年以来「アメリカの社会的風景」を主題として撮り続けてきた写真家として、ジョン・ザルコウスキーが1966年にジョージ・イーストマン・ハウスで企画した展覧会「社会的風景に向けて」に名を連ねた*1。1967年のMoMA「ニュー・ドキュメンツ」展（ダイアン・アーバス・ガリー・ウィノグランドとともに）への参加は、フリードランダーをアメリカ写真の新しい世代の代表として決定的に位置づけた*2。彼の特徴的な手法はフレームの中に「ストリート・ファーニチャー」——街路標識・電話ボックス・チェーンフェンス——とショーウィンドウの断片的な反射を詰め込む複雑な構成であり、また窓・鏡への映り込み、あるいは影だけとして自らを画面に組み込む「セルフポートレート」手法で知られる。「写真家が環境の一部として意識的に写真に入り込む」というこのアプローチは、当時の写真家自身を不可視にすることが常識だった時代に対するラディカルな提案だった*3。フリードランダーの画面はウォーカー・エヴァンズとユージン・アジェの明晰さを継承しながら、ポップ・アートの皮肉とユーモアを組み合わせたと評されている*4。2005年にMoMAで大規模な回顧展が開催され、写真・セルフポートレート・ヌード・風景・都市の各シリーズが網羅された。シカゴ美術館・メトロポリタン美術館・国立美術館・ホイットニー美術館など主要機関が作品を収蔵しており、ロバート・フランク以降のアメリカ写真を定義した写真家の一人として位置づけられている*5。',
      citations: [
