const PHOTOGRAPHERS = [
...

  {
    ...
    context: {
      ...
      textEn: 'Nobuyoshi Araki turned the intimate details of his own life into the basis of an art practice. His self-published book Sentimental Journey, made from photographs taken on his honeymoon with Yoko in 1971, transformed hotel rooms, breakfasts, windows, and private moments into the material of photography*1. Araki called this approach I-photography, borrowing from the Japanese I-novel and insisting that subjective lived experience could be a legitimate artistic subject*3. Love, sex, death, and time remained the core of his work, and after Yoko\'s death he transformed grief itself into a sequence of books. Although he moved near the spirit of postwar Japanese avant-garde photography, Araki followed a distinct path in which photography became at once diary, performance, and life practice*5.',
      citations: [
...

  {
    ...
    context: {
      ...
      textEn: 'Shomei Tomatsu made postwar Japan itself into his subject. Having directly experienced defeat and occupation, he distrusted official images and insisted on recording Japan from within rather than through the eyes of foreign journalists or occupying forces*1. With the VIVO group, he helped establish a subjective documentary approach that fused record with expressive angles, symbolism, and visual intensity*2. Series such as Occupation: Chewing Gum and Chocolate and his work on Nagasaki showed how Americanization, war memory, and nuclear violence remained embedded in Japanese daily life*3. In 11:02 Nagasaki he paired hibakusha portraits with objects scarred by the atomic blast, proving that historical violence could be represented through its traces*4. Tomatsu became one of the decisive figures linking realist postwar documentary to the later radicalism of Provoke and postwar Japanese photography at large*5.',
      citations: [
...

  {
    ...
    context: {
      ...
      textEn: 'Garry Winogrand made street photography feel fast, unstable, and improvisational. Carrying a 35mm Leica through New York, he built pictures out of tilted frames, diagonal pressures, blurred movement, and crowded public encounters*1. In New Documents he was identified as one of the central photographers of his generation, and John Szarkowski helped legitimize the so-called snapshot aesthetic as a distinctly photographic language rather than a technical failure*2. Winogrand famously said he photographed to see what the world looked like photographed, refusing to begin with a fixed message. Even his controversial book Women are Beautiful belongs to that larger attempt to register American social change through restless looking*3. The huge archive he left behind after his early death only reinforced his image as a photographer driven by seeing itself*4.',
      citations: [
...

  {
    ...
    context: {
      ...
      textEn: 'Lee Friedlander made what he called the social landscape, a photography of roads, storefronts, signs, windows, cars, and other elements of the built environment rather than of untouched nature*1. In New Documents he was identified as part of a generation turning documentary toward a more personal way of knowing the world*2. His pictures layer reflections, windows, mirrors, fences, and street furniture so that transparency and blockage coexist inside the same frame, making modern urban space feel visually restless*3. He also repeatedly inserted himself into the image as a shadow or reflection, challenging the assumption that the photographer should remain invisible. Friedlander became one of the defining figures of postwar American photography by turning ordinary visual clutter into a sophisticated language of structure and wit*5.',
      citations: [
...

  {
    ...
    context: {
      ...
      textEn: 'Diane Arbus left fashion photography behind in the late 1950s and, under the influence of Lisette Model, turned toward people living at the edges of social normality*1. She spent long periods with her subjects and made frontal portraits whose intimacy challenged accepted ideas of proper distance between photographer and sitter. In New Documents she was presented as part of a generation redirecting documentary toward personal vision rather than social reform*2. Pictures such as Identical Twins became icons of a new kind of portraiture in which vulnerability, exposure, and strangeness could not be separated*3. After her death in 1971, her reputation grew rapidly, and her work came to mark a major turning point in the history of photography*5.',
      citations: [
...

  {
    ...
    context: {
      ...
      textEn: `Daido Moriyama was born in Ikeda, Osaka, in 1938. After assisting Takeji Iwamiya and Eikoh Hosoe, he went independent in 1961 and joined the photography journal Provoke from its second issue in 1968. Though the magazine lasted only three issues, it transformed Japanese photographic expression. Its subtitle, "provocative materials for thought," captured the intellectual and political charge of the moment*1. Moriyama's contribution was the rough visual language later summarized as are, bure, boke - grain, blur, and out-of-focus imagery - which rejected established ideas of clean, well-made photography. In high-contrast black and white, his fragments of the city gave direct form to the instability and disorientation of high-growth Japan*2. In 1972 he published Farewell Photography, a book that pushed the dismantling of the photographic medium itself further than almost anyone had before, and which later entered the Tate collection as a landmark of postwar photographic experimentation*3. Since the late 1960s he has produced more than 150 photobooks, continually reworking both subject and form. A 2012-13 Tate Modern exhibition pairing him with William Klein was widely seen as the first substantial attempt to think seriously about the relation between their practices*2. In 2019 he received the Hasselblad Award, whose jury chair described him as one of the most important and influential photographers in history*4. MoMA holds his work in its permanent collection*5. Drawing on figures such as Klein and Walker Evans while forging his own language on the streets of Tokyo, Moriyama established a hand-held, fast-moving practice that made photography feel inseparable from walking, collision, and urban noise. His Provoke-era work ran parallel to the intensity of student protest in 1968-69 and preserved the sense that photography could become a tool for confronting the contradictions of society itself. From Japan: A Photo Theater to Shinjuku, Koori, and Farewell Photography, he repeatedly renewed the photobook as a form, and even in later life moved fluidly between film prints and images made on a mobile phone, sustaining a lifelong inquiry into what photography can be.`,
      citations: [
