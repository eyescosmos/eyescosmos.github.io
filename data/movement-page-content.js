...
const MOVEMENT_PAGE_CONTENT = {
  ...
  'フォトジャーナリズム': {
    ...
    sectionsJa: sections(DOCUMENTARY_HEADINGS, [
      ...
      'それでもフォトジャーナリズムは、写真が現場と公共圏を結ぶ手段としてどこまで働きうるかを最も濃密に試してきた領域です。[[m:ドキュメンタリー|ドキュメンタリー]]、[[m:決定的瞬間|決定的瞬間]]、[[m:ストリート写真|ストリート写真]]との違いを見比べることで、その制度的な輪郭がはっきりします。',
    ]),
  ...
  'シネマトグラフィック写真': {
    ...
    sectionsJa: sections(POST_HEADINGS, [
      ...
      'それでもシネマトグラフィック写真は、写真が時間をどう暗示できるかを考えるための有効なカテゴリーです。[[m:決定的瞬間|決定的瞬間]]が一点の時間の凝縮であるなら、こちらは前後に開いた時間の気配を一枚へ留める方法として対照的に読めます。',
    ]),
    sources: [...STAGED_SOURCES],
  },
};
