window.PHOTOGRAPHER_AFFILIATE_BOOKS = window.PHOTOGRAPHER_AFFILIATE_BOOKS || {};
...
window.PHOTOGRAPHER_AFFILIATE_BOOKS.stieglitz = {
  featured: {
    ja: { label: 'Amazonで見る ↗', url: 'https://amzn.to/...' },
    en: { label: 'View on Amazon ↗', url: 'https://amzn.to/...' }
  },
  books: [
    {
      titleJa: 'アルフレッド・スティーグリッツ 写真集',
      titleEn: 'Alfred Stieglitz: Photographs',
      noteJa: '入門として読みやすい代表的な一冊。',
      noteEn: 'A strong introductory volume on Stieglitz.',
      urlJa: 'https://amzn.to/...',
      urlEn: 'https://amzn.to/...'
    }
  ]
...
window.PHOTOGRAPHER_AFFILIATE_BOOKS.daguerre = {
  featured: {
    ja: { label: 'Amazonで見る ↗', url: 'https://amzn.to/47GqZth' },
    en: { label: 'View on Amazon ↗', url: 'https://amzn.to/3O7yClH' }
  },
  books: [
    {
      titleJa: 'Louis Daguerre',
      titleEn: 'Louis Daguerre',
      noteJa: '写真誕生以前の光学ショーから像の定着へ向かう原点を押さえる本。',
      noteEn: 'A strong starting point for the move from optical spectacle to the fixed photographic image.',
      urlJa: 'https://amzn.to/47GqZth',
      urlEn: 'https://amzn.to/3O7yClH'
    }
  ]
};
...
window.PHOTOGRAPHER_AFFILIATE_BOOKS.talbot = {
  featured: {
    ...
    en: { label: 'View on Amazon ↗', url: 'https://amzn.to/4tqMgPV' }
  },
  books: [
    {
...
window.PHOTOGRAPHER_AFFILIATE_BOOKS.fenton = {
  featured: {
    ...
    en: { label: 'View on Amazon ↗', url: 'https://amzn.to/4sObWpJ' }
  },
  books: [
    {
      titleJa: 'Roger Fenton: Photographer of the Crimean War',
      titleEn: 'Roger Fenton: Photographer of the Crimean War',
      noteJa: '戦争写真が何を見せ何を隠したかを考える入口。',
...
window.PHOTOGRAPHER_AFFILIATE_BOOKS.beato = {
  featured: {
    ...
    en: { label: 'View on Amazon ↗', url: 'https://amzn.to/4m7y8Zn' }
  },
  books: [
    {
      ...
      urlJa: 'https://amzn.to/4ts7tsG',
      urlEn: 'https://amzn.to/4m7y8Zn'
    }
  ]
};

window.PHOTOGRAPHER_AFFILIATE_BOOKS.nadar = {
  featured: {
    ja: { label: 'Amazonで見る ↗', url: 'https://amzn.to/3PMgmPu' },
    en: { label: 'View on Amazon ↗', url: 'https://amzn.to/3Q36JvH' }
  },
  books: [
    {
      ...
      urlEn: 'https://amzn.to/3Q36JvH'
    }
  ]
};

window.PHOTOGRAPHER_AFFILIATE_BOOKS.legray = {
  featured: {
    ja: { label: 'Amazonで見る ↗', url: 'https://amzn.to/4bRGz7L' },
    en: { label: 'View on Amazon ↗', url: 'https://amzn.to/4mcYObd' }
  },
  books: [
    {
...
window.PHOTOGRAPHER_AFFILIATE_BOOKS.muybridge = {
  featured: {
    ja: { label: 'Amazonで見る ↗', url: 'https://amzn.to/3Qj5RmM' },
    en: { label: 'View on Amazon ↗', url: 'https://amzn.to/4c7FkjC' }
  },
  books: [
    {
      titleJa: 'Muybridge: The Complete Human and Animal Locomotion',
      titleEn: 'Muybridge: The Complete Human and Animal Locomotion',
      noteJa: '運動分解と映画前史を一気に見渡せる定番。',
      noteEn: 'A standard volume for motion studies and the prehistory of cinema.',
      urlJa: 'https://amzn.to/3Qj5RmM',
...
window.PHOTOGRAPHER_AFFILIATE_BOOKS.marey = {
  featured: {
    ja: { label: 'Amazonで見る ↗', url: 'https://amzn.to/3OisV4A' },
    en: { label: 'View on Amazon ↗', url: 'https://amzn.to/41O5XFu' }
  },
  books: [
    {
...
window.PHOTOGRAPHER_AFFILIATE_BOOKS.riis = {
  featured: {
    ja: { label: 'Amazonで見る ↗', url: 'https://amzn.to/4c7N0CH' },
    en: { label: 'View on Amazon ↗', url: 'https://amzn.to/4sf0Bhs' }
  },
  books: [
    {
...
window.PHOTOGRAPHER_AFFILIATE_BOOKS.marville = {
  featured: {
    ja: { label: 'Amazonで見る ↗', url: 'https://amzn.to/4coiRA5' },
    en: { label: 'View on Amazon ↗', url: 'https://amzn.to/47DBwWa' }
  },
  books: [
    {
...
window.PHOTOGRAPHER_AFFILIATE_BOOKS.annan = {
  featured: {
    ja: { label: 'Amazonで見る ↗', url: 'https://amzn.to/4maAM0B' },
    en: { label: 'View on Amazon ↗', url: 'https://amzn.to/4sKZjf8' }
  },
  books: [
    {
      ...
      urlEn: 'https://amzn.to/4sKZjf8'
    }
  ]
};

window.PHOTOGRAPHER_AFFILIATE_BOOKS.brady = {
  featured: {
    ja: { label: 'Amazonで見る ↗', url: 'https://amzn.to/4va8lUH' },
    en: { label: 'View on Amazon ↗', url: 'https://amzn.to/47EYmfX' }
  },
  books: [
    {
      titleJa: 'Mathew Brady: Portraits of a Nation',
      titleEn: 'Mathew Brady: Portraits of a Nation',
      noteJa: '戦争の視覚記録が大衆に届く瞬間を読む一冊。',
      noteEn: 'Shows the moment war imagery reached a mass public.',
      urlJa: 'https://amzn.to/4va8lUH',
      urlEn: 'https://amzn.to/47EYmfX'
    }
  ]
};

window.PHOTOGRAPHER_AFFILIATE_BOOKS.cameron = {
  featured: {
    ja: { label: 'Amazonで見る ↗', url: 'https://amzn.to/3NN5xMt' },
    en: { label: 'View on Amazon ↗', url: 'https://amzn.to/4e8LouK' }
  },
  books: [
    {
...
window.PHOTOGRAPHER_AFFILIATE_BOOKS.emerson = {
  featured: {
    ja: { label: 'Amazonで見る ↗', url: 'https://amzn.to/4medUNN' },
    en: { label: 'View on Amazon ↗', url: 'https://amzn.to/3NHcgHO' }
  },
  books: [
    {
...
window.PHOTOGRAPHER_AFFILIATE_BOOKS.stieglitz = {
  featured: {
    ...
    en: { label: 'View on Amazon ↗', url: 'https://amzn.to/4tsEepB' }
  },
  books: [
    {
